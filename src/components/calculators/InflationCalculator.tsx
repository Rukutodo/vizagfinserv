  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="lg:w-7/12 bg-white/40 backdrop-blur-md rounded-3xl p-8 lg:p-10 border border-white/60 shadow-sm space-y-8 flex flex-col justify-between"
      >
        <div>
      ...
      <motion.div
        ...
        className="lg:w-5/12 bg-brand-900 text-white p-8 lg:p-10 flex flex-col justify-between rounded-3xl shadow-lg border border-brand-800"
      >
