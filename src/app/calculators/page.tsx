            ...
            {tabs.map((tab, i) => {
              ...
              return (
                <motion.button
                  ...
                  className={`flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl text-xs md:text-sm font-semibold transition-all duration-300 cursor-pointer w-[calc(33.333%-6px)] lg:w-auto lg:flex-1 ${
                    isActive
